...
class Entity extends \Concrete\Core\Entity\Express\Entity implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'handle', 'plural_handle', 'supports_custom_display_order', 'description', 'result_column_set', 'include_in_public_list', 'entity_results_node_id', 'attributes', 'associations', 'forms', 'default_view_form', 'default_edit_form', 'entries', 'created_date'];
        }
