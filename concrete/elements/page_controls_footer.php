            ...
            <ul class="ccm-toolbar-item-list">
                ...
                if ($cp->canEditPageContents() && (!$pageInUseBySomeoneElse)) {
                    ...
                    <li data-guide-toolbar-action="add-content" class="ccm-toolbar-add pull-left hidden-xs">
                        ...
                        <?php } else { ?>
                            <a href="<?php echo DIR_REL ?>/<?php echo DISPATCHER_FILENAME ?>?cID=<?php echo $cID ?>&ctask=check-out-add-block<?php echo $token ?>" title="<?php echo t('Add Content to The Page') ?>">
                                <i class="fa fa-plus"></i><span class="ccm-toolbar-accessibility-title ccm-toolbar-accessibility-title-add"><?php echo tc('toolbar', 'Add Content') ?></span>
                            </a>
                        <?php } ?>
                    </li>
                ...
                if ($dh->canRead()) {
                    ...
                    <li data-guide-toolbar-action="dashboard" class="pull-right hidden-xs ">
                        <a href="<?php echo URL::to('/dashboard') ?>" data-launch-panel="dashboard" title="<?php echo t('Dashboard – Change Site-wide Settings') ?>">
                    ...
                    <li class="pull-right hidden-xs">
                        <a href="<?php echo URL::to('/login', 'logout', $valt->generate('logout'))?>" title="<?php echo t('Sign Out')?>">
                ...
                <li data-guide-toolbar-action="sitemap" class="pull-right hidden-xs">
                    <a href="#" data-panel-url="<?php echo URL::to('/ccm/system/panels/sitemap') ?>" title="<?php echo t('Add Pages and Navigate Your Site') ?>" data-launch-panel="sitemap">
