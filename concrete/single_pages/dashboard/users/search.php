<?php if (isset($user) && is_object($user)) {
    ...
    ?>><?php echo h($user->getUserName()) ?></span></p>
                        </div>
                    </div>
                    <div class="row">
    ...
    ?><a href="#" class="btn btn-xs btn-default"
                                                                                 data-button="change-password"><?php echo t('Change') ?></a><?php
} else {
    ?>*********<?php
}
    ?>
    ...
    ?>data-editable-field-type="xeditable"
                                        ...
                                        data-value="<?php echo h($uTimezone) ?>"<?php
}
    ?>><?php echo $dh->getTimezoneDisplayName($uTimezone) ?></span>
                                </p></div>
                        </div>
                    <?php
}
    ...
    ?>data-editable-field-type="xeditable"
        ...
        ?>><?php echo h($user->getUserDefaultLanguage());
        ?></span>
                                </p></div>
                        </div>
                    <?php
