...
<section id="ccm-menu-page-attributes">
    ...
    ?>
				<li><a data-attribute-key="<?php echo $key->getAttributeKeyID()?>" <?php if (in_array($key->getAttributeKeyID(), $selectedAttributeIDs)) {
    ?>class="ccm-menu-page-attribute-selected" <?php 
}
    ?> href="javascript:void(0)"><?php echo $key->getAttributeKeyDisplayName()?></a></li>
			<?php 
}
    ?>
			</ul>
